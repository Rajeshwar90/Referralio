...
//$transactions_query = "select res2.*, Doctor_name as doc_ref_id_Doctor_name,Doctor_mobile_number as doc_ref_id_Doctor_mobile_number from (select res1.*,Doctor_name as reg_by_doc_Doctor_name,Doctor_mobile_number as reg_by_doc_Doctor_mobile_number from (SELECT Patient_thread_id,Patient_Name,Patient_mobile_number,Reg_by_doc,doc_ref_id,primary_status,secondary_status,created_by,audio_val,Timestamp FROM patient_stub ps inner join hospital_refer_out_doctor_stub hds on ps.Reg_by_doc=hds.doctor_stub_id or ps.doc_ref_id=hds.doctor_stub_id where hds.hospital_id='$hospital_id' order by Timestamp desc)as res1 inner join doctor_stub ds on res1.Reg_by_doc=ds.Doctor_serial_id)as res2 inner join doctor_stub sd on res2.doc_ref_id=sd.Doctor_serial_id";

$transactions_query="select res2.*, Doctor_Title as doc_ref_id_Doctor_Title,Doctor_name as doc_ref_id_Doctor_name,Doctor_mobile_number as doc_ref_id_Doctor_mobile_number from (select res1.*,Doctor_Title as reg_by_doc_Doctor_Title,Doctor_name as reg_by_doc_Doctor_name,Doctor_mobile_number as reg_by_doc_Doctor_mobile_number from (SELECT Patient_thread_id,Patient_Name,Patient_mobile_number,Reg_by_doc,doc_ref_id,primary_status,secondary_status,created_by,audio_val,Timestamp FROM patient_stub ps where ps.hospital_id_transaction='$hospital_id' order by ps.Timestamp desc)as res1 inner join doctor_stub ds on res1.Reg_by_doc=ds.Doctor_serial_id)as res2 inner join doctor_stub sd on res2.doc_ref_id=sd.Doctor_serial_id";
...
$referring_in_query = "select ds.Doctor_serial_id,ds.Doctor_Title,ds.Doctor_name,ds.Doctor_email,ds.Doctor_mobile_number,ds.Doctor_specialization,ds.Doctor_qualification,ds.Doctor_yxp from hospital_refer_in_doctor_stub hs inner join doctor_stub ds on hs.doc_stub_id=ds.Doctor_serial_id and hs.refer_by_hos_id='$hospital_id'";
$result_referring_in_query = mysql_query ( $referring_in_query);
$count_refer_in_query = mysql_num_rows ( $result_referring_in_query);

$referring_in_query_drop = "select ds.Doctor_serial_id,ds.Doctor_Title,ds.Doctor_name,ds.Doctor_email,ds.Doctor_mobile_number,ds.Doctor_specialization,ds.Doctor_qualification,ds.Doctor_yxp from hospital_refer_in_doctor_stub hs inner join doctor_stub ds on hs.doc_stub_id=ds.Doctor_serial_id and hs.refer_by_hos_id='$hospital_id' UNION SELECT ds.Doctor_serial_id,ds.Doctor_Title,ds.Doctor_name,ds.Doctor_email,ds.Doctor_mobile_number,ds.Doctor_specialization,ds.Doctor_qualification,ds.Doctor_yxp FROM `hospital_refer_in_doctor_stub` hs inner join doctor_stub ds on hs.refer_in_doc_mobile=ds.Doctor_mobile_number where hs.refer_by_hos_id='$hospital_id' and doc_stub_id=''";
$result_referring_in_query_drop = mysql_query ( $referring_in_query_drop );
$count_refer_in_query_drop = mysql_num_rows ( $result_referring_in_query_drop );
...
$query_referring_in_analytics="select Doctor_Title,Doctor_name,Reg_by_doc,count(*) as cnt,doc_ref_id from patient_stub ps inner join doctor_stub ds on ps.Reg_by_doc=ds.Doctor_serial_id where Reg_by_doc in (select doc_stub_id from hospital_refer_in_doctor_stub rs where rs.refer_by_hos_id='$hospital_id' and rs.doc_stub_id!= '') and doc_ref_id in(select doctor_stub_id from hospital_refer_out_doctor_stub where hospital_id='$hospital_id' )group by Reg_by_doc";
$result_referring_in_analytics=mysql_query($query_referring_in_analytics);

$query_add_help="select * from clarification_member_by_hospital where hospital_id='$hospital_id'";
$result_add_help=mysql_query($query_add_help);
$count_add_help=mysql_num_rows($result_add_help);
if($count_add_help>0){
    $row_add_help=mysql_fetch_assoc($result_add_help);
}
...
$query_super_mapped_users="select * from doctor_stub where Doctor_yxp='$hospital_id' and type_value='hospital_user_all'";
$res_super_mapped_users=mysql_query($query_super_mapped_users);
$count_mapped_super_users=mysql_num_rows($res_super_mapped_users);

$query_hospital_doc_analytics="Select Doctor_Title,Doctor_name,doc_ref_id,count(*) as cnt from patient_stub ps inner join doctor_stub ds on ps.doc_ref_id=ds.Doctor_serial_id where doc_ref_id in(select doctor_stub_id from hospital_refer_out_doctor_stub where hospital_id='$hospital_id')  group by doc_ref_id order by cnt desc";
...
<title><?php echo $hospital_name;?> Admin Panel</title>
...
<!-- <link rel="stylesheet" href="css/thickbox_modal.css">
<link rel="stylesheet" href="css/style_modal.css">
<script src="js/thickbox_modal.js" type="text/javascript"></script>-->
...
<!-- Modal for edit transacctions -->
<div class="modal fade" id="edit-patient-info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"></div>
<!-- end of modal -->

<!-- Modal for discharge document upload -->
<div class="modal fade" id="edit-discharge-info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"></div>
<!-- end of modal -->

<!-- Modal for edit ref doc upload -->
<div class="modal fade" id="edit-ref-doc-info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"></div>
<!-- end of modal -->
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
									<select name="doc_title" id="doc_title" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<div><input type="text" class="form-control" placeholder=""
									name="name" id="name" value=""
									onKeyDown="return ValidateAlpha(event);"></div>
							</div>
						</div>
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label class="col-lg-4 control-label">Title</label>
							<div class="col-lg-8">
									<select name="doc_title1" id="doc_title1" class="form-control">
									<option value="Select" selected>Select</option>
									<option value="Dr.">Dr.</option>
									<option value="Mr.">Mr.</option>
									<option value="Mrs.">Mrs.</option>
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<div class="input-group">
									<select id="tran_ref_doc_id" class="selectpicker  form-control" data-live-search="true">
										<option value="Select" selected>Please Select</option>
                                       <?php
																																							while ( $hos_row_ref = mysql_fetch_assoc ( $result_referring_in_query_drop ) ) {
																																								?>
                                       <option
											value='<?php echo $hos_row_ref['Doctor_serial_id'];?>'><?php echo $hos_row_ref['Doctor_Title']; ?> <?php echo $hos_row_ref['Doctor_name'];?></option>
<?php }?>
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<div class="input-group">
									<select id="tran_hos_doc_id" class="selectpicker  form-control" data-live-search="true">
										<option value="Select" selected>Please Select</option>
                                       <?php
																																							while ( $hos_row_doc = mysql_fetch_assoc ( $result_refer_out_query ) ) {
																																								?>
                                       <option
											value='<?php echo $hos_row_doc['Doctor_serial_id'];?>'><?php echo $hos_row_doc['Doctor_Title'];?><?php echo $hos_row_doc['Doctor_name'];?></option>
<?php }?>
...
<div class="modal fade" id="addhspuser" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Add Manage users</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" role="form">
					    <div class="form-group">
							<label class="col-lg-4 control-label">Title</label>
							<div class="col-lg-8">
									<select name="doc_title2" id="doc_title2" class="form-control">
									<option value="Select" selected>Select</option>
									<option value="Mr.">Mr.</option>
									<option value="Mrs.">Mrs.</option>
									</select>
	...
	<span class="pink"><i class="fa fa-lg fa-pencil-square-o"></i></span>
	</div>
						<div class="default">
	...
	<div class="modal fade" id="changepassword" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal">
						...
						<div class="form-group">
							<label class="col-lg-4 control-label">Confirm Password</label>
							<div class="col-lg-8">
								<input type="password" class="form-control" name="user_pass3"
									id="user_pass3" value="">
							</div>
						</div>
						<input type="hidden" name="hospital_id" id="hospital_id"
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-danger" onclick="modal_change_pass()">Update Password</button>
				</div>
			</div>
		</div>
	</div>
	<!-- modal for add management people -->
	<div class="modal fade" id="addmanagement" tabindex="-1" role="dialog"
		aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Add Management</h4>
				</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control" placeholder="name"
									name="mng_name_help" id="mng_name_help" value=""
									onKeyDown="return ValidateAlpha(event);">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control"
									placeholder="10 digit mobile" name="mng_mobile_help" id="mng_mobile_help"
									value="" onKeyPress="return restrictInput(this,event,digitsOnly)">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-4 control-label">Password</label>
							<div class="col-lg-8">
								<input type="password" class="form-control"
									placeholder="password" name="mng_pass_help" id="mng_pass_help"
									value="">
							</div>
						</div>
						<input type="hidden" name="hospital_id" id="hospital_id"
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-danger" onclick="add_mng()">save</button>
				</div>
			</div>
		</div>
	</div>
	<!-- end of add management people -->
	<!-- modal for profile -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Add Help</h4>
				</div>
				
				<div class="modal-body">
				<?php if($count_add_help > 0){
					    $action=1;//update
					}else{
					    $action=0;//insert
					}?>
					<form class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control" placeholder="name"
									name="name_help" id="name_help" value="<?php echo $row_add_help['person_name']; ?>"
									onKeyDown="return ValidateAlpha(event);">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control"
									placeholder="10 digit mobile" name="mobile_help" id="mobile_help"
									value="<?php echo $row_add_help['mobile_number']; ?>" onKeyPress="return restrictInput(this,event,digitsOnly)">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-4 control-label">Extra Notes</label>
							<div class="col-lg-8">
								<textarea rows="3" class="form-control" name='extra_notes' id='extra_notes' cols="50"><?php echo $row_add_help['extra_notes']; ?></textarea>
							</div>
						</div>
						<input type="hidden" name="hospital_id" id="hospital_id"
							value="<?php echo $hospital_id ?>" />
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-danger" onclick="add_help()">save</button>
				</div>
			</div>
		</div>
	</div>
				...
				<li class="dropdown pull-right "><a data-toggle="dropdown"
					...
					<ul class="dropdown-menu">
						<li><a href="#" data-toggle="modal" data-target="#profile"><i
								class="fa fa-user"></i> Add Help</a></li>
						<li><a href="#" data-toggle="modal" data-target="#changepassword"><i
								class="fa fa-cogs"></i> Change Password</a></li>
						<li><a href="#" data-toggle="modal" data-target="#addmanagement"><i
								class="fa fa-cogs"></i> Add Management</a></li>	
	...
	<div class="container">
		<div class="row top-padd">
			<div class="col-md-12">
				<h2><?php echo $_SESSION['hospital_name_SESSION'];?></h2>
				<img src="img/referralio.png" class="logo">
										...
										<table
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo $row['Doctor_Title'];?><?php echo $row['Doctor_name'];?></td>
											...
											while ( $row = mysql_fetch_assoc ( $result_referring_in_query ) ) {
												...
												<tr>
													...
													<td>
														...
														<!-- <a href='' id='<?php echo $row['Doctor_mobile_number'];?>' class="edit-ref-doc-link"><span class="label label-edit ">EDIT</span></a>-->
									...
									<div class="table-responsive">
										...
										<table
											...
											while ( $row = mysql_fetch_assoc ( $result_pending_referring_doctors ) ) {
												?>
												<tr>
													<td><?php echo $row['refer_in_doc_title'];?><?php echo $row['refer_in_doc_name'];?></td>
													...
													<td>
														...
														<a href='' id='<?php echo $row['refer_in_doc_mobile'];?>' class="edit-ref-doc-link"><span class="label label-edit ">EDIT</span></a>
					...
					<div class="row">
						<div class="padd">
							<button class="btn btn-danger pull-right" type="button"
								...
								<i class="fa fa-plus bigger-110"></i> Add Referral
							</button>
						</div>
					</div>
										...
										<table
											...
											while ( $row = mysql_fetch_assoc ( $result_transactions ) ) {
												...
												<tr>
													...
													<td><a href="" class="transaction-patient-link" id='<?php echo $row['Patient_thread_id'];?>'><?php echo $row['Patient_Name']."( ".$row['Patient_mobile_number']." )";?></a><a href='' class="edit-patient-link" id='<?php echo $row['Patient_thread_id'];?>'><span class="label label-edit ">EDIT</span></a></td>	
													<td><?php echo $row['reg_by_doc_Doctor_Title']; ?><?php echo $row['reg_by_doc_Doctor_name'].'('.$row['reg_by_doc_Doctor_mobile_number'].')';?><!-- <a href="#"><i class="fa fa-inbox"></i></a> --></td>
													<td><?php echo $row['doc_ref_id_Doctor_Title']; ?><?php echo $row['doc_ref_id_Doctor_name'].'('.$row['doc_ref_id_Doctor_mobile_number'].')';?></td>
													...
													<td><select name="status" id="status_transaction" class="form-control" onchange="change_secondary(this,<?php echo $row['Patient_thread_id'];?>)">
															...
															<option name="Treated" value="Treatment In Progress"<?php if ($row['secondary_status'] == 'Treatment In Progress') echo ' selected="selected"'; ?>>Treatment In Progress</option>
															<option name="Discharged" value="Discharged"<?php if ($row['secondary_status'] == 'Discharged') echo ' selected="selected"'; ?>>Discharged</option>
														</select>
														<!-- <a href="#">Upload</a> -->
														<?php if ($row['secondary_status'] == 'Treatment In Progress'){?>
														<p style="display:block" id="uploadp"></span><a href="upload.php?placeValuesBeforeTB_=savedValues&TB_iframe=true&height=300&width=400&modal=true" class="edit-discharge-link" id='<?php echo $row['Patient_thread_id'];?>'>Upload</a></p>
														<?php } ?>
													</td>
													...
													<?php }?>
													 <td><?php if($row['audio_val']!=''){?>
													 <audio   controls>
        <!-- <source src="http://www.w3schools.com/html/horse.ogg" type="audio/mpeg">
        <source src="http://www.w3schools.com/html/horse.mp3" type="audio/ogg"> -->
        <source src="<?php echo "../dual_referral/transaction_audio_rec/".$row
        ['audio_val']?>" type="audio/mpeg">
        <source src="<?php echo "../dual_referral/transaction_audio_rec/".$row
        ['audio_val']?>" type="audio/ogg">
        Your browser does not support the HTML5 audio element.
    </audio><?php }else{?>
    <b><center>Not a audio Transaction</center></b>
    <?php } ?>
    </td>
												</tr>
<?php
					...
					<div class="row">
						<div class="padd">
							<button class="btn btn-danger pull-right" type="button"
								...
								<i class="fa fa-plus "></i> Add Hospital Users
							</button>
						</div>
					</div>
					<div class="row">
            ...
            while ( $row_hospital_user = mysql_fetch_assoc ( $result_hospital_users ) ) {
                ?>
												...
												<input type="hidden" name="hospital_id" id="hospital_id"
													value="<?php echo $hospital_id ;?>" />
												<tr>
													<td><?php echo $row_hospital_user['Doctor_Title']; ?><?php echo $row_hospital_user['Doctor_name']; ?></td>
                ...
                while ( $row_referring_in = mysql_fetch_assoc ( $result_referring_in_query ) ) {
                    ...
                    ?>
																<option
																value="<?php echo $row_referring_in['Doctor_serial_id']?>"><?php echo $row_referring_in['Doctor_Title']?><?php echo $row_referring_in['Doctor_name']?></option>
																<?php
            ...
            while ( $row_hospital_user = mysql_fetch_assoc ( $result_hospital_users ) ) {
                ?>
												...
												<input type="hidden" name="hospital_id" id="hospital_id"
													value="<?php echo $hospital_id ;?>" />
												<tr>
													<td width="45%"><?php echo $row_hospital_user['Doctor_Title']; ?><?php echo $row_hospital_user['Doctor_name']; ?></td>
													<?php
													...
													//echo mysql_num_rows($res_get_refer_mapped);
													...
													{	
													?>
																<option value="<?php echo $row_get_refer_mapped['Doctor_serial_id']; ?>"><?php echo $row_get_refer_mapped['Doctor_Title']; ?><?php echo $row_get_refer_mapped['Doctor_name']; ?></option>
        ...
        ?>
					...
					<div class="row">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left widgehead">Mapped SuperUser(Count:<?php echo $count_mapped_super_users;?>)</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="fa fa-refresh"></i>Reload</a>
							...
							<div class="widget-content">
								<div class="page-tables">
									<div class="table-responsive">
										...
										<?php
										//echo "hello".$count_mapped_super_users;
        if ($count_mapped_super_users != 0) {
            ?>
										<table
											class="table table-striped table-bordered table-hover data-table"
											style="height: auto">
											...
											<tbody>
											<?php
											//mysql_data_seek ( $res_super_mapped_users, 0 );
            while ( $row_super_user = mysql_fetch_assoc ( $res_super_mapped_users ) ) {
                ?>

												<input type="hidden" name="stub_id" id="stub_id"
													value="<?php echo $row_super_user['Doctor_serial_id'];?>" />
												<input type="hidden" name="hospital_id" id="hospital_id"
													value="<?php echo $hospital_id ;?>" />
												<tr>
													<td width="45%"><?php echo $row_super_user['Doctor_Title']; ?><?php echo $row_super_user['Doctor_name']; ?></td>
													<td width="45%"><?php echo $row_super_user['Doctor_mobile_number']; ?></td>
													<td><button class="btn btn-xs btn-danger" id="button_2"
															value="Delete"
															onclick="delete_hospital_user_all(<?php echo $row_super_user['Doctor_serial_id'];?>)">
															<i class="fa fa-times"></i>
														</button></td>
												</tr>
            ...
            echo "No Super Users mapped yet";
        }
        ?>
									</div>
								</div>
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('a.edit-patient-link').on('click', function() {
          // this is how you access the patient id that you specified
          var patientId = $(this).attr("id");
          //var hospital_id=document.getElementById('hospital_id').value;
          //alert(patientId);
          ...
          //return false;
          // build your ajax url using the patient id
          var url = "getPatInfo.php?patient=" + patientId;
          $.get(url, function(data) {
            //alert(data);
            $("#edit-patient-info").html(data).modal('show');
          });
          return false;
        });

      $('a.edit-discharge-link').on('click', function() {
          // this is how you access the patient id that you specified
          var patientId = $(this).attr("id");
          //var hospital_id=document.getElementById('hospital_id').value;
          alert(patientId);
          ...
          //return false;
          // build your ajax url using the patient id
          var url = "dischargefileupload.php?patient=" + patientId;
          $.get(url, function(data) {
            //alert(data);
            $("#edit-discharge-info").html(data).modal('show');
          });
          return false;
        });


      $('a.edit-ref-doc-link').on('click', function() {
          // this is how you access the patient id that you specified
          var refdocId = $(this).attr("id");
          //var hospital_id=document.getElementById('hospital_id').value;
          if(refdocId == ''){
              alert("You will not be able to edit the ref doc.Please contact admin");
              return false;
              }
          alert(refdocId);
          //return false;
          ...
          //return false;
          // build your ajax url using the patient id
          var url = "editrefdoc.php?refdocId=" + refdocId;
          $.get(url, function(data) {
            //alert(data);
            $("#edit-ref-doc-info").html(data).modal('show');
          });
          return false;
        });
