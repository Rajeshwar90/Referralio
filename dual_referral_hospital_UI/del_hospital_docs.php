...
//changed query
$result_query_broadcast_insert=mysql_query("delete from hospital_refer_out_doctor_stub where doctor_stub_id='$doctor_id' and hospital_id='$hospital_id'");
...
if($result_query_broadcast_insert){
   $success = array('status' => "Success", "msg" => "Successfully doctor has been deleted from hospital");
